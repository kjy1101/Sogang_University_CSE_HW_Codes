...
double _f_vehicle(double x) {
	return (89 * sin(11.5)) * sin(x) * cos(x) + (89 * cos(11.5)) * sin(x) * sin(x) - ((49 + 0.5 * 55) * sin(11.5) - 0.5 * 55 * tan(11.5)) * cos(x) - ((49 + 0.5 * 55) * cos(11.5) - 0.5 * 55) * sin(x);
}

double _fp_vehicle(double x) {
	return (89 * sin(11.5)) * (cos(x) * cos(x) - sin(x) * sin(x)) + (89 * cos(11.5)) * (2 * sin(x) * cos(x)) + ((49 + 0.5 * 55) * sin(11.5) - 0.5 * 55 * tan(11.5)) * sin(x) - ((49 + 0.5 * 55) * cos(11.5) - 0.5 * 55) * cos(x);
}
